...
export default function Login(props) {
  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center items-center bg-home bg-cover">
      <form
        className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 md:shadow-lg md:bg-black"
        onSubmit={event => {
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <button className="bg-red-500 hover:bg-red-700 text-white md:text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
            Login
          </button>
          <Link
